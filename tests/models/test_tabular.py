...
def test_state_value_model():
    """Tests :class:`tested_module.StateValueModel`"""

    # random parameters
    states = list(range(10))
    num_states = len(states)

    m = tested_module.StateValueModel(num_states)
...
def test_state_policy_model():
    """Tests :class:`tested_module.StatePolicyModel`"""
    ...
    m = tested_module.StatePolicyModel(num_states, num_actions)
...
def test_history_value_model(hist, target):
    """Tests :class:`tested_module.HistoryValueModel`"""

    m = tested_module.HistoryValueModel()
...
def test_history_policy_model(hist, target):
    """Tests :class:`tested_module.HistoryPolicyModel`"""
    ...
    m = tested_module.HistoryPolicyModel(num_actions)
